import { AwsAlbListenerArn, AwsAlexaEventToken, AwsArn, AwsArnString, AwsCfFunction, AwsCfGetAtt, AwsCfIf, AwsCfImport, AwsCfInstruction, AwsCfJoin, AwsCfRef, AwsHttpApiPayload, AwsKmsArn, AwsLambdaArchitecture, AwsLambdaEnvironment, AwsLambdaLayers, AwsLambdaMemorySize, AwsLambdaRole, AwsLambdaRuntime, AwsLambdaTimeout, AwsLambdaTracing, AwsLambdaVersioning, AwsLambdaVpcConfig, AwsLogGroupName, AwsLogRetentionInDays, AwsResourceCondition, AwsResourceDependsOn, AwsResourceTags, AwsSecretsManagerArnString, EcrImageUri, FilterPatterns, FunctionName } from '@serverless/typescript';
